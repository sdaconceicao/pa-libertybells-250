...
import type { GeocodedBell } from "../src/lib/bells/types.js";
...
async function main() {
  ...
  console.log("Geocoding bell addresses with Nominatim...");
  const geocoded: GeocodedBell[] = await geocodeBellAddresses(rawBells);
